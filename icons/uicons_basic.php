...
<?php if(!user_is_logged_in()) { ?>
	<a href="<?php print "https://artsandsciences.osu.edu/Shibboleth.sso/Login?target=https%3A%2F%2Fartsandsciences.osu.edu%2F%3Fq%3Dshib_login%252Fnode";?>"><img src="<?php print base_path() . path_to_theme() ;?>/icons/user.gif" height="13px" title="Site Administrator Login" alt="Site Administrator Login" /></a>
<?php } else { ?>
